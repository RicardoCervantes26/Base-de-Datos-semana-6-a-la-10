...
GO
--FUNCION--
CREATE FUNCTION fn_CalcularPrecioConDescuento (@Precio DECIMAL(10,2), @Porcentaje INT)
...
GO
--LLAMAR FUNCION--
SELECT Nombre, Precio AS PrecioOriginal, 
       dbo.fn_CalcularPrecioConDescuento(Precio, 15) AS PrecioConOferta
FROM Productos;
